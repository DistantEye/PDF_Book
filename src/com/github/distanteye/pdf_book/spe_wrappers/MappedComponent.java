...
public class MappedComponent {
	...
	public AccessWrapper<String> getLinkedData() {
		return linkedData;
	}
	...
	public void update()
	{
		...
		else
		{
			...
			{
				// it won't let us change field mid notification normally
				SwingUtilities.invokeLater(new Runnable() {

					@Override
					public void run() {
						setCompText(lastValue);
					}					
				});
